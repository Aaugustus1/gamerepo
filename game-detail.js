...
(function () {
  ...
  const FALLBACK_GAMES = {
    'meccha-chameleon': {
      ...
      genres: ['Action', 'Indie', 'Party', 'Casual'],
      cloudReady: true,
      playersOnline: 4210,
      streamUrl: 'https://store.steampowered.com/app/2026000/Meccha_Chameleon/',
      description: 'Meccha Chameleon is a viral multiplayer hide-and-seek party game. Players paint their characters using color wheels and eye-droppers to match the surroundings, strike poses to blend in, and evade seekers before time runs out.',
      screenshots: []
    },
